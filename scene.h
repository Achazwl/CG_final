...
static Group group(std::vector<Object3D*>{ // x, y, -z
	...
	new Mesh(Vec(1, 0, 0), Vec(98, 81.6, -1), "mesh/cube.obj", new Material{Vec(), Vec(.75,.75,.75), Refl::DIFFUSE, "images/Teacup.png"}), // Back
	new Mesh(Vec(1, 0, 170), Vec(98, 81.6, 1), "mesh/cube.obj", new Material{Vec(), Vec(.9,.75,.75), Refl::DIFFUSE}), // Front

	new Mesh(Vec(1, 0, 0), Vec(98, -1, 170), "mesh/cube.obj", new Material{Vec(),Vec(.75,.75,.75), Refl::DIFFUSE, "images/wood.jpg"}), //Botm 
	...
	new Sphere(10.5, Vec(42,10.5,93),        new Material{Vec(),Vec(),  Refl::DIFFUSE, "images/volleyball.jpg"}), //ball 3
